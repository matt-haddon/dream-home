...
class AndroidBuilder {
  ...
  async ensureProjectConfiguredAsync() {
    ...
    const isProjectConfigured = await _config().AndroidConfig.EasBuild.isEasBuildGradleConfiguredAsync(projectDir);
  ...
  async configureProjectAsync() {
    ...
    await (0, _git2().modifyAndCommitAsync)(async () => {
      await _config().AndroidConfig.EasBuild.configureEasBuildAsync(projectDir);

      const easGradlePath = _config().AndroidConfig.EasBuild.getEasBuildGradlePath(projectDir);
